...
public class DynamicArray<T> implements Iterable<T> {
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < array.getF(); i++) {
      array.setObject(i, i * 5);
      System.out.print(array.getObject(i) + " ");;
    }
    System.out.print("\n");
    // ---
    array.append(1);
    array.trimToCapacity(5);
    // ---
    for (int i = 0; i < array.getF(); i++) {
      System.out.print(array.getObject(i) + " ");;
    }
    ...
    System.out.println("Capacity: " + array.getLength());
    System.out.println("Length: " + array.getF());
  }
